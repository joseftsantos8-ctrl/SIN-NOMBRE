...
import { abrirModalSolicitudes } from '../suministros/solicitudes.js';
import { abrirModalInventarioSuministros } from '../suministros/inventario-suministros.js';
import { abrirModalReportes } from '../reportes/exportar.js';
import { abrirEscaner } from '../escaner/escaner.js';
...
const roleOptions = {
    'Colaborador': [
        ...
        { icon: 'fa-boxes-packing',    title: 'Solicitar Suministros', action: abrirModalSolicitudes }
    ],
    'Gerente': [
        ...
        { icon: 'fa-map-location-dot', title: 'Planos de Tienda',      action: abrirModalPlanos },
        { icon: 'fa-warehouse',        title: 'Inventario Materiales', action: abrirModalInventarioSuministros },
        { icon: 'fa-file-export',      title: 'Reportes Exportables',  action: abrirModalReportes }
    ],
    'Sugerente': [
    ...
    'Líder de Inventario': [
        ...
        { icon: 'fa-map-location-dot',   title: 'Planos de Tienda',     action: abrirModalPlanos },
        { icon: 'fa-boxes-packing',      title: 'Solicitar Suministros',action: abrirModalSolicitudes },
        { icon: 'fa-barcode',            title: 'Escanear Código',      action: () => abrirEscaner() },
        { icon: 'fa-file-export',        title: 'Reportes Exportables', action: abrirModalReportes }
    ],
    'Líder de Almacén': [
    ...
    'POP': [
        ...
        { icon: 'fa-map-location-dot', title: 'Planos de Tienda',         action: abrirModalPlanos },
        { icon: 'fa-clipboard-list',   title: 'Gestionar Solicitudes',    action: abrirModalSolicitudes }
    ],
    'Admin': [
        ...
        { icon: 'fa-map-location-dot', title: 'Planos de Tienda',      action: abrirModalPlanos },
        { icon: 'fa-warehouse',        title: 'Inventario Materiales', action: abrirModalInventarioSuministros },
        { icon: 'fa-boxes-packing',    title: 'Gestionar Solicitudes', action: abrirModalSolicitudes },
        { icon: 'fa-file-export',      title: 'Reportes Exportables',  action: abrirModalReportes },
        { icon: 'fa-barcode',          title: 'Escanear Código',       action: () => abrirEscaner() },
